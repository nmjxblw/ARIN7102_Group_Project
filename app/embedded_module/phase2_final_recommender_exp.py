...
class ExperimentalPhase2FinalRecommender:
    """Phase II wrapper that preserves the current post-processing flow.

    Scope: This class is only for offline evaluation. It keeps the existing
    half-confirmed/fallback selection logic unchanged and only swaps the phase2
    Top-K source mode used inside ExperimentalDrugRecallPipeline.
    """
    ...
    def __init__(
        ...
        *,
        ...
        from app.evaluation.half_data_adapter import _canonical_drug_name, _load_table_name_map, _parse_labels
